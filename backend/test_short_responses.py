#!/usr/bin/env python3
"""
Test script to verify short responses
"""
...
def test_short_responses():
    """Test the short response format"""
    
    # Test with the new format
    test_prompt = """You are a helpful AI. Give short, direct answers.
...
Human: what is 2+3?"""
    ...
    print("🧪 Testing Short Response Format")
    print("=" * 60)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if len(cleaned_response) < 100 and "5" in cleaned_response:
