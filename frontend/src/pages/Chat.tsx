...
const Chat = () => {
  ...
  return (
    <>
      <div className="fixed inset-0 top-0 left-0 right-0 bottom-0 w-full h-full flex flex-col overflow-x-hidden" style={{ margin: 0, padding: 0, paddingTop: 0, marginTop: 0, zIndex: 1 }}>
        <div className={`flex-1 flex gap-0 bg-white dark:bg-[#1e1e1e] overflow-hidden h-full min-w-0 mt-12 md:mt-12 ${isCollapsed ? 'md:ml-12' : 'md:ml-44'} transition-[margin] duration-300 ease-in-out`}>
          <ChatSidebar
