...
import { Flame, Target, Clock, Star, Trophy, Zap, UserPlus, UserMinus, MessageCircle, ArrowLeft } from 'lucide-react';
            ...
            <div className="flex items-center gap-4">
              {avatarUrl ? (
                <img
                  ...
                  className="w-20 h-20 rounded-full object-cover border-4 border-indigo-200 dark:border-indigo-800"
                />
              ) : (
                <div className="w-20 h-20 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center border-4 border-indigo-200 dark:border-indigo-800">
