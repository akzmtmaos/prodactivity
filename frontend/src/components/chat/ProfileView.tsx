...
import { Flame, Target, Clock, Star, Trophy, Zap, UserPlus, UserMinus, MessageCircle, ArrowLeft, FileText, Layers, BookOpen, CheckSquare, Brain, HelpCircle, Calendar, BarChart3, Award, CheckCircle, Notebook } from 'lucide-react';
...
const ProfileView: React.FC<ProfileViewProps> = ({ username, onClose, onStartChat }) => {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto bg-gray-50 dark:bg-gray-900 p-6">
            ...
            {!profile.is_own_profile && (
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border border-indigo-600 text-indigo-600 bg-white dark:bg-transparent rounded-lg font-medium hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors"
                >
